...
[中文](7.RAG学习/dive-into-langgraph/附录/app/README.md)) | English
![gradio-app](gradio_app.webp))
...
- **tools**:
    - **Web search**:[tool_search](tool_search.py))
    - **Math**:[tool_math](7.RAG学习/dive-into-langgraph/附录/app/tools/tool_math.py))
    - **Role-play**:[role-play](tool_role.py))
- **MCP**:
    - **Code execution**:[code-execution](code_execution.py))
    - **Chart visualization**:[mcp-server-chart](7.RAG学习/dive-into-langgraph/附录/app/mcp/mcp-server-chart/README.md))
...
- [x] **Chain-of-thought capture**: developed[DashScopeChatOpenAI](fix_dashscope.py)) for DashScope API to capture chain-of-thought
