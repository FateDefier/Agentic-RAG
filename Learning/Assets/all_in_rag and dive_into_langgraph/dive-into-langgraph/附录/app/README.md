...
中文 | [English](7.RAG学习/dive-into-langgraph/附录/app/docs/README-en.md)
...
- **tools**：
    - **联网搜索**：[tool_search](tool_search.py)
    - **四则运算**：[tool_math](7.RAG学习/dive-into-langgraph/附录/app/tools/tool_math.py)
    - **科学计算**：[tool_sci](tool_sci.py)
    - **角色扮演**：[role-play](tool_role.py)
- **MCP**：
    - **代码执行**：[code-execution](code_execution.py)
    - **图表可视化**：[mcp-server-chart](7.RAG学习/dive-into-langgraph/附录/app/mcp/mcp-server-chart/README.md)
...
- [x] **思维链捕获**：针对 DashScope API 开发 [DashScopeChatOpenAI](fix_dashscope.py) 用于获取思维链内容
...
- [x] **支持本地模型**：增加了使用 Ollama 部署本地模型的 [说明](ollama.md)
