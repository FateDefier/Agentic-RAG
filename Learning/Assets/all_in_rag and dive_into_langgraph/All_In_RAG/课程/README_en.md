...
<div align='center'>
  <img src="https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/logo.svg" alt="All-in-RAG Logo" width="70%">
</div>
...
## Project Introduction（[中文](7.RAG学习/All_In_RAG/课程/README.md) | English）
...
**Chapter 1 Unlocking RAG** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter1)
1. [x] [RAG Introduction](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter1/01_RAG_intro.md) - RAG technology overview and application scenarios
2. [x] [Preparation](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter1/02_preparation.md) - Environment configuration and preparation
3. [x] [Four Steps to Build RAG](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter1/03_get_start_rag.md) - Quick start with RAG development

**Chapter 2 Data Preparation** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter2)
1. [x] [Data Loading](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter2/04_data_load.md) - Multi-format document processing and loading
2. [x] [Text Chunking](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter2/05_text_chunking.md) - Text segmentation strategies and optimization

### Part II: Index Construction and Optimization

**Chapter 3 Index Construction** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter3)
1. [x] [Vector Embedding](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter3/06_vector_embedding.md) - Detailed explanation of text vectorization technology
2. [x] [Multimodal Embedding](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter3/07_multimodal_embedding.md) - Image-text multimodal vectorization
3. [x] [Vector Database](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter3/08_vector_db.md) - Vector storage and retrieval systems
4. [x] [Milvus Practice](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter3/09_milvus.md) - Milvus multimodal retrieval practice
5. [x] [Index Optimization](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter3/10_index_optimization.md) - Index performance tuning techniques

### Part III: Advanced Retrieval Techniques

**Chapter 4 Retrieval Optimization** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter4)
1. [x] [Hybrid Search](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter4/11_hybrid_search.md) - Dense + sparse retrieval fusion
2. [x] [Query Construction](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter4/12_query_construction.md) - Intelligent query understanding and construction
3. [x] [Text2SQL](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter4/13_text2sql.md) - Natural language to SQL query
4. [x] [Query Rewriting and Routing](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter4/14_query_rewriting.md) - Query optimization strategies
5. [x] [Advanced Retrieval Techniques](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter4/15_advanced_retrieval_techniques.md) - Advanced retrieval algorithms

### Part IV: Generation and Evaluation

**Chapter 5 Generation Integration** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter5)
1. [x] [Formatted Generation](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter5/16_formatted_generation.md) - Structured output and format control

**Chapter 6 RAG System Evaluation** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter6)
1. [x] [Evaluation Introduction](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter6/18_system_evaluation.md) - RAG system evaluation methodology
2. [x] [Evaluation Tools](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter6/19_common_tools.md) - Common evaluation tools and metrics

### Part V: Advanced Applications and Practice

**Chapter 7 Advanced RAG Architecture (Extended Elective)** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter7)

1. [x] [Knowledge Graph-based RAG](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter7/20_kg_rag.md)

**Chapter 8 Project Practice I (Basic)** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter8)
1. [x] [Environment Configuration and Project Architecture](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter8/01_env_architecture.md)
2. [x] [Data Preparation Module Implementation](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter8/02_data_preparation.md)
3. [x] [Index Construction and Retrieval Optimization](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter8/03_index_retrieval.md)
4. [x] [Generation Integration and System Integration](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter8/04_generation_sys.md)

**Chapter 9 Project Practice I Optimization (Elective)** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter9)

[🍽️ Project Demo](https://github.com/FutureUnreal/What-to-eat-today)
1. [x] [Graph RAG Architecture Design](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter9/01_graph_rag_architecture.md)
2. [x] [Graph Data Modeling and Preparation](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter9/02_graph_data_modeling.md)
3. [x] [Milvus Index Construction](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter9/03_index_construction.md)
4. [x] [Intelligent Query Routing and Retrieval Strategy](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter9/04_intelligent_query_routing.md)

**Chapter 10 Project Practice II (Elective)** [📖 View Chapter](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/en/chapter10) *In Planning*
...
![Project I](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/project01.png)

### Chapter 9 Project I (Graph RAG Optimization):

![Project I (Graph RAG Optimization)](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/project01_graph.png)
...
![star](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/emoji.png)
