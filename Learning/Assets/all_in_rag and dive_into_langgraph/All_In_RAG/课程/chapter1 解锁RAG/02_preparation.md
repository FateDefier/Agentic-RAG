...
1. **访问 AIHubmix 平台**
   ...
   ![AIHubmix](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1.png)
2. **登录或注册账号**
...
3. **模型筛选**
   ...
   ![模型页面](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/2.png)
4. **管理 API 密钥**

   接着进入[密钥管理页面](https://console.aihubmix.com/token)，如下图所示，默认已经有了一个密钥可以直接复制使用。当然也可以点击 `创建 Key` 填写名称后重新创建一个。

   ![密钥管理](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/3.png)
...
1. **访问 Deepseek 开放平台**
   ...
   ![Deepseek 平台首页](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_1.webp)
2. **登录或注册账号**
...
3. **创建新的 API 密钥**
   ...
   ![创建新密钥按钮](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_2.webp)
4. **保存 API Key**
   ...
   ![复制并保存密钥](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_3.webp)
...
2. **创建新分支**
   ...
   ![创建新分支1](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_4.webp)

   ![创建新分支2](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_5.webp)
3. **创建Codespaces**
   在项目页面的右上角，点击 `Code` 按钮，然后选择 `Codespaces` 选项卡。点击 `New codespace` 按钮，等待新的 Codespaces 环境创建成功。

   ![创建Codespaces](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_6.webp)
4. **再次进入Codespaces**
   网页关闭后，找到刚才新建的存储库，点击红框框选内容即可重新进入 codespace 环境。

   ![再次进入Codespaces](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_7.webp)
5. **额度设置**
   找到 GitHub 的账户设置中的 codespace 设置，挂起时间建议根据自己情况调整（时间过长会浪费额度，免费账号提供了单核120小时的额度）

   ![额度设置](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_8.webp)

### 2.2 python环境配置

进入 IDE 后先选择下方终端

![进入终端](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_9.webp)
...
```
    ...
    ``bash     export AIHUBMIX_API_KEY=[你的大模型 API 密钥]     ``
...
3. **创建应用**
   ...
   ![创建应用](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_10.webp)
...
4. **再次进入**
   ...
   ![再次进入应用](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_11.webp)

### 3.2 python环境配置

进入 IDE 后先选择右侧终端

![进入终端](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_12.webp)
...
3. 在 “系统属性” 对话框中，点击 “高级” 选项卡，然后点击下方的 “环境变量” 按钮。
   ...
   ![高级系统设置](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_13.webp)
4. 在 “环境变量” 对话框中，点击 “新建”（在 “用户变量” 部分下），然后输入以下信息：

   - 变量名：DEEPSEEK_API_KEY
   - 变量值：[你的 Deepseek API 密钥]

   ![高级系统设置](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_14.webp)
...
2. **运行安装向导**
   ...
   * **Welcome**: 点击 `Next`。
     ...
     ![Welcome](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_16.webp)
   * **License Agreement**: 点击 `I Agree`。

     ![License Agreement](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_17.webp)
   * **Installation Type**: 选择 `Just Me`，点击 `Next`。

     ![Installation Type](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_18.webp)
   * **Choose Install Location**: 建议保持默认路径，或选择一个不含中文和空格的路径。点击 `Next`。

     ![Install Location](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_19.webp)
   * **Advanced Installation Options**: **请不要勾选** “Add Miniconda3 to my PATH environment variable”。我们将稍后手动配置环境变量。点击 `Install`。

     ![Advanced Options](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_20.webp)
...
3. **手动配置环境变量**
   ...
   * 在Windows搜索栏中搜索“编辑系统环境变量”并打开。
     ...
     ![编辑系统环境变量](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_21.webp)
   * 在“系统属性”窗口中，点击“环境变量”。

     ![环境变量按钮](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_22.webp)
   * 在“环境变量”窗口中，找到“系统变量”下的 `Path` 变量，选中并点击“编辑”。

     ![编辑Path变量](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_23.webp)
   * 在“编辑环境变量”窗口中，新建三个路径，将它们指向你 Miniconda 的安装目录下的相应文件夹。如果你的安装路径是 `D:\Miniconda3`，则需要添加：
     ...
     ![添加路径](https://raw.githubusercontent.com/datawhalechina/all-in-rag/main/docs/chapter1/images/1_2_24.webp)
   * 完成后，一路点击“确定”保存更改。
