...
```
(all-in-rag) ubuntu@ac2d418d5b9a:/workspace/code/C1$ python 01_langchain_example.py
content='根据提供的上下文，文中举了以下例子：\n\n1. **自然界中**：羚羊通过试错学会站立和奔跑。\n2. **股票交易**：通过买卖股票，根据市场反馈来最大化奖励。\n3. **玩雅达利游戏或其他电脑游戏**：通过不断试错来学会通关。\n4. **雅达利的Pong游戏**：强化学习智能体通过策略网络学习决策，并与正常选手进行对比。\n5. **选择餐馆**：利用指去最喜欢的餐馆，探索指尝试新餐馆。\n6. **做广告**：利用指采取最优广告策略，探索指尝试新广告策略。\n7. **挖油**：利用指在已知地方挖油，探索指在新地方挖油。\n8. **玩游戏（如《街头霸王》）**：利用指采取固定策略（如蹲在角落出脚），探索指尝试新招式。' additional_kwargs={'refusal': None} response_metadata={'token_usage': {'completion_tokens': 186, 'prompt_tokens': 5550, 'total_tokens': 5736, 'completion_tokens_details': None, 'prompt_tokens_details': {'audio_tokens': None, 'cached_tokens': 0}, 'prompt_cache_hit_tokens': 0, 'prompt_cache_miss_tokens': 5550}, 'model_name': 'deepseek-v4-flash', 'system_fingerprint': 'fp_8b330d02d0_prod0820_fp8_kvcache_20260402', 'id': '6d0688c7-f72d-4457-93e6-58e4733a56e5', 'service_tier': None, 'finish_reason': 'stop', 'logprobs': None} id='run--e9b35743-a313-4cc0-a217-432f1cd6e2c7-0' usage_metadata={'input_tokens': 5550, 'output_tokens': 186, 'total_tokens': 5736, 'input_token_details': {'cache_read': 0}, 'output_token_details': {}}
(all-in-rag)
```
